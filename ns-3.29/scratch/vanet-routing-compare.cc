...
//追加
  double bsm_pdr20 = m_waveBsmHelper.GetWaveBsmStats ()->GetCumulativeBsmPdr (20);
 ...
 " BSM_PDR20=" << bsm_pdr20 << " Goodput=" << averageRoutingGoodputKbps << "Kbps MAC/PHY-oh=" << mac_phy_oh);

///////////////////////////////////////////////////
  double totalAppPacket;
  totalAppPacket = totalAppBytes / 64; 
  double totalPhyPacket;
  totalPhyPacket = totalPhyBytes / 64;

std:: cout << "totalAppBytes=" << totalAppBytes << " totalPhyBytes=" << totalPhyBytes << " totalAppPacket=" << totalAppPacket << " totalPhyPacket= " << totalPhyPacket << std::endl;
/////////////////////////////////////////////////////
    }
...
VanetRoutingExperiment::Run ()
{
  ...
  AnimationInterface anim ("vanet-routing-compare.xml");
...
VanetRoutingExperiment::CommandSetup (int argc, char **argv)
{
  ...
  double txDist8 = 500.0;
  double txDist9 = 500.0;
...
VanetRoutingExperiment::SetupAdhocMobilityNodes ()
{
  if (m_mobility == 1)
  ...
  else if (m_mobility == 2)
    {
      ...
      pos.Set ("X", StringValue ("ns3::UniformRandomVariable[Min=0.0|Max=10000.0]"));
      pos.Set ("Y", StringValue ("ns3::UniformRandomVariable[Min=0.0|Max=10000.0]"));
...
/*
      ...
      m_traceFile = "/home/fk/sumo/test40/test40mobility.tcl";
      //m_traceFile = "/home/fk/sumo/test1mobility.tcl";
      m_logFile = "sumo2.log";
      m_mobility = 1;
      m_nNodes = 30;
      ...
      m_nodeSpeed = 40;
      m_nodePause = 0;
      m_CSVfileName = "sumo_vanet-routing-compare1.csv";
      m_CSVfileName2 = "sumo_vanet-routing-compare12.csv";
*/
      ...
      m_nodeSpeed = 40;
      m_nodePause = 0;
      m_CSVfileName = "test1mobility-1olsr.csv";
      m_CSVfileName2 = "test1mobility-2olsr.csv";
