...
//p2pnode1がcsmanode1になる
  csmaNodes.Add (p2pNodes.Get (1)); //n1
  csmaNodes.Create (nCsma); //n2,3,4
...
//wifi
  ...
  wifiStaNodes.Create (nWifi); //n4,5,6
...
//animation
//  AnimationInterface anim ("third-anim.xml");

  //anim.SetConstantPosition(network);
