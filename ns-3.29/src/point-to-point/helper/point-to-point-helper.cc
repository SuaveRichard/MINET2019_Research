...
PointToPointHelper::Install (Ptr<Node> a, Ptr<Node> b)
{
      ...
      //std::cout << "PointToPointHelper Install\n";
  ...
  container.Add (devA);
  container.Add (devB);
        //std::cout << "PointToPointHelper Install end\n";
  return container;
}
...
PointToPointHelper::Install (Ptr<Node> a, std::string bName)
{
        ...
        //std::cout << "PointToPointHelper Install 2\n";
...
PointToPointHelper::Install (std::string aName, Ptr<Node> b)
{
        ...
        //std::cout << "PointToPointHelper Install 3\n";
...
PointToPointHelper::Install (std::string aName, std::string bName)
{
        ...
        //std::cout << "PointToPointHelper Install 4\n";
