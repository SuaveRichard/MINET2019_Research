...
/*
void
RoutingProtocol::PrintPromiscReceived (Ptr<Socket> socket, Ptr<Packet> packet, Address srcAddress)
{
...
void
 RoutingProtocol::ReceivePacket (Ptr<Socket> socket)
{
  Ptr<Packet> packet;
  Address srcAddress;
  while (packet = socket->RecvFrom (srcAddress)){
    std::cout << RoutingProtocol::PrintPromiscReceived (socket, packet, srcAddress) << "\n" << std::endl;
  }
}
*/
...
//////////////////////////////////////////////////////////////////////////////////
  //m_ipv4->GetNetDevice (0)->SetPromiscReceiveCallback (MakeCallback (&ReceivePacket), this);
