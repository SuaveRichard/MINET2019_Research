 ...
 * \file
 * \ingroup manet_dtn
 * ns3::Manet_Dtn::TypeHeader, ns3::Manet_Dtn::SummaryVectorHeader
 * and ns3::Manet_Dtn::Manet_DtnHeader declarations.
 */
...
/**
 * \ingroup manet_dtn
 * \brief  Manet_Dtn routing packet type header.
 *
 * Manet_Dtn routing packets come in three types:
 *
...
{
public:
  /// MessageType enum, several types for manet_dtn control packets
  enum MessageType
  {
...
/**
* \ingroup manet_dtn
* \brief    Manet_Dtn Summary Vector Header
...
/**
 * \ingroup manet_dtn
 * \brief Output streamer for Manet_DtnSummaryVectorHeader.
 *
 * \param os The stream.
 * \param packet The Manet_DtnSummaryVectorHeader.
 * \returns The stream.
 */
 ...
 *  The Manet_Dtn Header consists of three fields:
 *
 ...
 *  The complete header is formatted as follows:
  ...
  \endverbatim
 */
class Manet_DtnHeader : public Header
{
public:
  /**
   * \brief Destructor.
   */
  virtual ~Manet_DtnHeader ();
  /**
...
/**
 * \ingroup manet_dtn
 * \brief Output streamer for Manet_DtnHeader.
 *
 * \param os The stream.
 * \param header The Manet_DtnHeader.
 * \returns The stream.
 */

std::ostream &operator<< (std::ostream& os,
                          const Manet_DtnHeader & header);
