 ...
 * \file
 * \ingroup manet_dtn
 * ns3::Manet_Dtn::QueueEntry and ns3::Manet_Dtn::PacketQueue declarations.
 */
...
/**
 * \ingroup manet_dtn
 * \brief Manet_Dtn queue
 * This queue contains Manet_Dtn packets.
 */
class PacketQueue
{
public:
  ...
  /**
   * \brief Find a packet in the Manet_Dtn queue based on the packetID.
